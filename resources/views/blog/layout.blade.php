...
<head>
  ...
  <!-- PLUGINS CSS STYLE -->
  <link href="{{ URL::asset('admin/assets/plugins/toaster/toastr.min.css') }}" rel="stylesheet" />
  <link href="{{ URL::asset('admin/assets/plugins/nprogress/nprogress.css') }}" rel="stylesheet" />
  <link href="{{ URL::asset('admin/assets/plugins/flag-icons/css/flag-icon.min.css') }}" rel="stylesheet" />
...
-->
  ...
  <script src="{{ URL::asset('admin/assets/plugins/toaster/toastr.min.js') }}"></script>
  ...
  <script src="{{ URL::asset('admin/assets/plugins/jquery-mask-input/jquery.mask.min.js') }}"></script>
  ...
  <script src="{{ URL::asset('admin/assets/js/map.js') }}"></script>
